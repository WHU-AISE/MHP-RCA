...
class _DiscreteTimeNetworkHawkesModelBase(object):
    ...
    # ADD BY  ZZK
    # figsize=(6,4) -> figsize=(10,10)
    def plot(self, fig=None, handles=None, figsize=(12,4), color="#377eb8",
        ...
        # plt.savefig('./testfig.svg',bbox_inches='tight')
